...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, init_type='normal', gpu_ids=[]):
    ...
    elif which_model_netG == 'znet_256':
        netG = ZnetGenerator(input_nc, output_nc, 8, ngf, norm_layer=norm_layer, use_dropout=use_dropout, gpu_ids=gpu_ids)
    else:
...
def define_D(input_nc, ndf, which_model_netD,
    ...
    elif which_model_netD == 'basic_z':
        netD = ZNLayerDiscriminator(input_nc, ndf, n_layers=2, norm_layer=norm_layer, use_sigmoid=use_sigmoid, gpu_ids=gpu_ids)
